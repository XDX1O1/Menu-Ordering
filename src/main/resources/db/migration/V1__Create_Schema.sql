-- ChopChop Restaurant Database Schema
-- Create database first: CREATE DATABASE restaurant_db;
...
-- menu_id is nullable and has no FK constraint to preserve logs of deleted menus
